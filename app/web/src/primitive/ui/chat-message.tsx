...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger
} from "@/primitive/ui/collapsible";
import { FilePreview } from "@/primitive/ui/file-preview";
import { MarkdownRenderer } from "@/primitive/ui/markdown-renderer";
  ...
  return (
    <div className="mb-2 flex flex-col items-start sm:max-w-[70%]">
      <Collapsible
        ...
        className="bg-muted/50 group w-full overflow-hidden rounded-lg border"
      >
