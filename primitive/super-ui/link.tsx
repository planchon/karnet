...
export const SuperLink = observer(function SuperLinkInner({ title, icon: Icon, tooltip, ...props }: SuperLinkProps) {
    const settings = useSettings();
    const linkEnabled = !settings.disableLinks;

    const isActive = useLocation().pathname.includes(props.to.toString());
