...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@/primitive/ui/dialog";
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
    return (
        <CommandPrimitive.List
            className={cn("mb-[5px] max-h-[300px] scroll-py-1 overflow-y-auto overflow-x-hidden", className)}
